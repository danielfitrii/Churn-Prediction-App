  ...
  function autoUpdateTotalCharges(nextFormData) {
    if (!totalChargesOverridden) {
      return {
        ...nextFormData,
        totalCharges:
          Number(nextFormData.tenure) * Number(nextFormData.monthlyCharges),
      };
    }
    return nextFormData;
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                {totalChargesOverridden && (
                  <button
                    type="button"
                    onClick={handleResetTotalCharges}
          ...
          {loading ? (
            ...
            <div className="h-64 flex flex-col items-center justify-center">
              ...
              <div className="mt-4 text-sm text-gray-600 text-center">
                {prediction.riskLevel === "Low" ? (
                  <p>
                    This customer has a low probability of churning. Continue
                    providing good service.
                  </p>
                ) : prediction.riskLevel === "Medium" ? (
                  <p>
                    This customer has a moderate risk of churning. Consider
                    proactive retention strategies.
                  </p>
                ) : (
                  <p>
                    This customer has a high risk of churning. Immediate
            ...
            <div className="h-64 flex items-center justify-center text-gray-400 text-center">
              <p>
                Enter customer data and click &quot;Predict Churn Risk&quot; to
                see the prediction
              </p>
            </div>
          )}
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                {selectedModel === "randomForest" &&
                  formData.tenure < 6 &&
                  formData.contract === "Month-to-month" && (
                    <li>• New customer with month-to-month contract (high risk)</li>
                  )}
              </ul>
            </div>
          )}
      ...
      <div className="mt-8 bg-blue-50 p-4 rounded-lg text-sm text-gray-700">
        <p>
          <strong>Note:</strong> This is a demonstration model simulating
          different ML algorithms. In a production environment, these buttons
          would connect to separate trained models via API endpoints.
        </p>
      </div>
    </div>
  );
