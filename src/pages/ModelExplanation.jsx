...
export default function ModelExplanation() {
    ...
    const modelData = {
        "Logistic Regression": {
            ...
            type: "Classification",
            pipeline: "Preprocessing ΓåÆ One-Hot Encoding & Feature Selection ΓåÆ Tomek Links (Undersampling) ΓåÆ Train-Test Split ΓåÆ Logistic Regression (with class weighting) ΓåÆ Hyperparameter Tuning (RandomizedSearchCV) ΓåÆ Threshold Tuning & Evaluation",
            features: [
        ...
        "Random Forest": {
            ...
            type: "Classification",
            pipeline: "Preprocessing ΓåÆ One-Hot Encoding & Feature Selection ΓåÆ Tomek Links (Undersampling) ΓåÆ Train-Test Split ΓåÆ Random Forest (with class weighting) ΓåÆ Hyperparameter Tuning (RandomizedSearchCV) ΓåÆ Threshold Tuning & Evaluation",
            features: [
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg mb-4">
                        <div className="flex flex-col space-y-2">
                            <div className="flex items-center">
                                ...
                                <span>Higher SHAP value ΓåÆ More likely to churn</span>
                            </div>
                            <div className="flex items-center">
                                <div className="w-4 h-4 bg-blue-500 rounded mr-2"></div>
                                <span>Lower SHAP value ΓåÆ Less likely to churn</span>
                            </div>
                        </div>
                    </div>
