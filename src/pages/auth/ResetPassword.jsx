...
const ResetPassword = () => {
  ...
  const inputClass = "appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm";
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                value={email}
                disabled
                className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 focus:outline-none sm:text-sm"
              />
            </div>
            <div className="relative">
              ...
              <input
                ...
                required
              />
              <button type="button" className="absolute inset-y-0 right-0 pr-3 flex items-center z-10" onClick={toggleShowPassword} aria-label={showPassword ? 'Hide password' : 'Show password'} aria-pressed={showPassword}>
